...
X1PID = PIDController(1.51, 8.79, 5.01, 0.1)
...
X0PID = PIDController(6.23, 8.31, 9.94, 0.1)


def system_dynamics_controller_2(t, X, U, setpoints):
    setpoints["X[1]"] = X0PID.update(setpoints["X[0]"], X[0])
    return system_dynamics_controller_1(t, X, U, setpoints)