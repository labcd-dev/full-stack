...
import { btnBase, btnPrimary, cardPanel, mutedText, pageIntro, pageSection } from '../lib/classes'
...
export function RecommenderPage() {
  ...
  const goToTrimmer = async (controller?: string | null) => {
    ...
    try {
      const handoff = await recommenderApi.handoff(jobId, {
        chosen_controller: controller ?? chosenController,
      })
  ...
  return (
    <section className={pageSection}>
      <h2 className="mt-0 text-foreground">Recommender Workspace</h2>
