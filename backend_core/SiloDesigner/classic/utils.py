...
from backend_core.SiloDesigner.src.simulation import GeneralDynamicalSystem, SimulationRunner
...
def compareMatlab(system_class: type[GeneralDynamicalSystem], control_params, scenario_data, num_runs=100):
    ...
    print(f"{'Stability Rate':<15} | {stats['stability_rate']:>8.2%}      | {'—':^8}")